...
const errors = [
  ...
  ['redeclaration of variable', 'yoo! fuzz x = 1 fuzz x = 2'],
  ['redeclared field', 'yoo! fuzz Dict<num> p = {r: num, r: num}'],
  ['no such field', 'yoo! fuzz Dict<num> p = {r: num} fuzz num s = p.zzz'],
